...
const DEFAULTS = {
  ...
  limits: {
    ...
    maxRunMinutes: 30,
    exhaustThreshold: 50,              // 连续 N 张"已沟通过"判定投穿 (Boss 推荐流切换阈值)
  },

  // 岗位筛选 (黑名单: 明确无关岗位, 优先于白名单)
  jobFilter: {
    blacklist: ['工程师', '设计师', '烘焙', '质检', 'QC', '专员', '助理', '实习',
                '厨师', '服务员', '保安', '保洁', '司机', '快递', '外卖',
                '店员', '收银', '仓库', '普工', '理货', '搬运', '缝纫', '裁剪'],
  },
